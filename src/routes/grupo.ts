...
import {get_populateGrupo,get_Grupos, get_Grupo, update_Grupo, delete_Grupo, join_Grupo, create_Grupo, insert_TicketGrupo, exit_Grupo} from "../controllers/grupo";
...
router.get("/:idGrupo/populate", get_populateGrupo);
